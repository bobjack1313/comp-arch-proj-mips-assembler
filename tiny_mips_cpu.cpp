...
// Need a funtion to run through each instruction segment


// Separate function to run Rtype


// Separate function to run Itype


// Separate function to run Jtype
...
// Function to display the value in the register


// Fetcher functions for each of the instruction segments
